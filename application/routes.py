...
processed_heartrate_data_dir = os.path.abspath(os.path.join(current_dir, '..', 'Processed_heartrate_data'))
processed_heartrate_sessions_dir = os.path.abspath(os.path.join(current_dir, '..', 'Processed_heartrate_sessions'))
